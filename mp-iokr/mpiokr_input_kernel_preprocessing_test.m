function [ KX_train_test ] = mpiokr_input_kernel_preprocessing_test ( ...
    KX_list_train_test, KX_list_test, process_input, mp_iokr_param, gamma_opt )
%======================================================
% DESCRIPTION:
...
%======================================================
    ...
    switch mp_iokr_param.rev_iokr
        case 'joint' % joint approximation
            ...
            KX_train_test = {input_kernel_preprocessing_test( ...
                KX_list_train_test, KX_list_test, process_input, mp_iokr_param.center)};
        ...
        case 'separate' % separate approximation
            ...
            case 4
                ...
                for j = 1:n_kx
                    KX_train_test{j} = input_kernel_preprocessing_test ( ...
                        KX_list_train_test{j}, KX_list_test{j}, process_input(j), mp_iokr_param.center);
                end
            ...
            case 5
                ...
                for j = 1:n_kx
                    KX_train_test{j} = input_kernel_preprocessing_test ( ...
                        KX_list_train_test(ic==j), KX_list_test(ic==j), process_input(ic==j), mp_iokr_param.center);
                end
            end
    end
end
